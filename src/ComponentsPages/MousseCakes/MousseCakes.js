...
import './mousseCakes.scss';

export default class MousseCakes extends Component {
   render(){
   return (
            ...
            <div className="container">
               <div className="row">
                  <div className="col-xl-12">
                     <h1 className="header__title">{this.props.data_mousse.menu_item_5}</h1>
            ...
            <div className="container">
               <div className="row justify-content-center">
                  <div className="col-xl-8">
                     <h2 className="product__title">{this.props.data_mousse.menu_item_5}</h2>
                  </div>
               </div>
